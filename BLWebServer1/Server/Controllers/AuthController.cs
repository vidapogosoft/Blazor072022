...
using BLWebServer1.Server;
using BLWebServer1.Shared;
...
namespace BLWebServer1.Server.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
		...
		{
			var secretkey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("CURSOSIPECOMSECRETKEYBLAZOR")); // NOTE: SAME KEY AS USED IN Startup.cs FILE
